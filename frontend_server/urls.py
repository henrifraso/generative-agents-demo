...
urlpatterns = [
    ...
    url(r'^api/auth/login/$',    translator_views.auth_login,    name='auth_login'),
    url(r'^api/auth/register/$', translator_views.auth_register, name='auth_register'),
    url(r'^api/auth/verify/$',   translator_views.auth_verify,   name='auth_verify'),
